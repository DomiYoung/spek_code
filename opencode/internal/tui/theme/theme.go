...
type Theme interface {
	...
	BackgroundTool() lipgloss.AdaptiveColor // Claude Code: --app-tool-background
...
type BaseTheme struct {
	...
	BackgroundToolColor lipgloss.AdaptiveColor
...
func (t *BaseTheme) BackgroundTool() lipgloss.AdaptiveColor { return t.BackgroundToolColor }
